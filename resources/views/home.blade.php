                    ...
                    <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                        ...
                        <ul class="details">
                            @if(Auth::guard('web')->check())
                                <li><p><span class="glyphicon glyphicon-earphone one" style="width:50px;"></span>{{Auth::guard('web')->user()->phone}}</p></li>
                            @endif
                            @if(Auth::guard('admin')->check())
                            ...
                            @endif
                            @if(Auth::guard('web')->check())
                                <li><p><span class="glyphicon glyphicon-earphone one" style="width:50px;"></span>{{Auth::guard('web')->user()->sex}}</p></li>
                            @endif
                                @if(Auth::guard('web')->check())
                                    <li><p><span class="glyphicon glyphicon-earphone one" style="width:50px;"></span>Suscripción: {{Auth::guard('web')->user()->suscripcion->name}}</p></li>
                                @endif
                        </ul>
