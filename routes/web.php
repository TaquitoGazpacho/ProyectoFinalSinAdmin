...
Route::prefix('admin')->group(function() {
    ...
    Route::post('/editarOficina/registrar', 'RegistroOficinaController@store')->name('registrarOficina');
    Route::post('/editarEmpresaReparto', 'RegistroEmpresaRepartoController@store')->name('registrarEmpresaReparto');
    Route::post('/editarEmpresaReparto', 'RegistroEmpresaRepartoController@store')->name('editarEmpresaReparto');
